...
import 'package:users/screens/otp_screen_login.dart';
import 'package:users/screens/otp_screen_register.dart';
      ...
      await FirebaseAuth.instance.verifyPhoneNumber(
        ...
        codeSent: (String verificationId, int? resendToken) {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (c) => OTPScreenRegister(
            name: nameTextEditingController.text, address: addressTextEditingController.text,
